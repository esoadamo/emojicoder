...
def decode(string: str) -> str:
    ...
    All characters outside EMOJIS are ignored
    :param string: EMOJIS!
    :return: original utf-8 string
    """
    return str(base64.b64decode(''.join(['' if ch not in EMOJIS else BASE64CHARS[EMOJIS.index(ch)] for ch in list(string)])), 'utf8')
